...
#### 2016-Ongoing (Graduating April 2021)
Carleton University's Bachelor of Information Technology is a 4 year program, with courses held 50/50 at Carleton University and Algonquin College.
...
Through this I have gained several hundred hours of hands-on experience with networking hardware including Aruba wireless APs/controllers, and Cisco Routers/Switches.
...
| Linux Networking | Using a Linux system as a server/router; DNS, DHCP, NTP, Apache, Docker, etc. | B |
| Basics of Transmission Systems | Transmissions techniques employed for various media (wired/radio) | B |
| Database Concepts and SQL | Database design using SQL | A |
...
## Work Experience
### [Government of Canada](https://www.canada.ca/home.html) | Network/System Administration, Software Development
#### May - August 2018, January - December 2019
Working within the federal government of Canada has provided me with uniquely varied work experience.

Given relative freedom to pursue projects which personally interest me, I have thrived and made extensive use of my networking knowledge as well as programming expertise gained through several years of personal hobbyism and formal training.
...
## Projects
### [FXGames (Java FX Games)](https://github.com/amcpeake/FXGames) | February 2019 - April 2019
...
Tractyl is an ongoing project between myself and a coworker and is an attempt to build a custom mechanical keyboard with an integrated trackball.

The idea rose from a desire to have complete mouse/keyboard control without moving your hands between two distinct devices.
In its current state we have a custom 3D-printed housing and are currently working on the interior circuitry, specifically feeding the trackball input into the microcontroller used for the keyboard logic.
...
### [Personal Website](https://www.amcpeake.com) (Currently down for maintenance) | July 2018 - Ongoing
...
* Hardware/Software/Network Troubleshooting | 1 year
* OpenVPN | 8 months
* ESXi | 6 months
* VMWare Horizon | 4 months
* Oracle VM | 4 months
